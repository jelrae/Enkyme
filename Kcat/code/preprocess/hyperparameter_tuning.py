...
# CV_train_indices = np.load(join(datasets_dir, "CV_train_indices_%s.npy" %organism), allow_pickle=True)
# CV_test_indices = np.load(join(datasets_dir, "CV_test_indices_%s.npy" %organism), allow_pickle=True)
